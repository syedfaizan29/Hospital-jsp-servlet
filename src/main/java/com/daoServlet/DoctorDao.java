...
public class DoctorDao {
	...
	public boolean addDoctors(DoctorEntity Dentity) {
		...
		try {
			String query = "insert into doctor_details(full_name,dob,qualification,specialist,email,mobile_no,password) value(?,?,?,?,?,?,?)";
	...
	public boolean updateDoctorsDetails(DoctorEntity Dentity) {
		...
		try {
			...
			String query = "update doctor_details set full_name=?,dob=?,qualification=?,specialist=?,email=?,mobile_no=?,password=? where id=?";
	...
	public boolean updateDoctorByEditProfile(DoctorEntity Dentity) {
		...
		try {
			...
			String query = "update doctor_details set full_name=?,dob=?,qualification=?,specialist=?,email=?,mobile_no=? where id=?";
